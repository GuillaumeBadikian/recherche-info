...
class Rank:
    ...
    def generateRuns(self,staff,step,run,queryId, weighting='ltn',granularity = "articles", params=None):
        ...
        f = open("C:/Users/guill/Documents/fac/master/2A/RI/recherche-info/src/runs/{}_{}_{}_{}_{}_{}.txt".format(staff,step,run,weighting,granularity,params ), "a")
        rank = 1
    ...
    def parse(self, corpus, lang="english", parser="[\w'/():\"@+-]*"):
        ...
        while (doc != -1):  # end file
            ...
            if docn != -1 and docne != -1:
                ...
                words = parse.findall(docs)
                self.corpusW[file[docn + 7:docne].decode("utf-8")] = [w.lower() for w in words if not w in stop_words and w != '' and w.isalpha()]
